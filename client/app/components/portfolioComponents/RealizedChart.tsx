...
const RealizedChart: React.FC<RealizedChartProp> = ({baseCurrency, realized}) => {
  // Example data for the coins
  const series = realized
  ...
  const options = {
    ...
    yaxis: {
      ...
      title: {
        text: 'Realized Gain/Loss (' + baseCurrency + ')', // Fixed typo in title
        style: {
          color: '#9ca3af',
        },
      }
  ...
  return (
    <div>
      ...
      <label className="text-white text-lg">Total Realized Gain/Loss</label>
      </div>
